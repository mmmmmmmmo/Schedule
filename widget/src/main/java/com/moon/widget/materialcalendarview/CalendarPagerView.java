...
import com.moon.widget.materialcalendarview.MaterialCalendarView.ShowOtherDates;
import com.moon.widget.materialcalendarview.format.DayFormatter;
...
import static com.moon.widget.materialcalendarview.MaterialCalendarView.SHOW_DEFAULTS;
import static com.moon.widget.materialcalendarview.MaterialCalendarView.showOtherMonths;
...
public abstract class CalendarPagerView extends ViewGroup
    ...
    private void buildWeekDays(LocalDate calendar) {
        ...
        for (int i = 0; i < DEFAULT_DAYS_IN_WEEK; i++) {
            WeekDayView weekDayView = new WeekDayView(getContext(), local);
...
//        Timber.d("specWidthSize= " + specWidthSize +
//                "specWidthMode =" + specWidthMode +
//                "specHeightSize= " + specHeightSize +
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (LocalUtils.isRTL()) {
               ...
               // Timber.d("childLeft: " + childLeft + "  childTop: " + childTop + "  width=" + width + "height:=" + height);
                childLeft += width;
            }

...
public final class EncryptUtils {
    ...
    public static String encryptAES2HexString(final byte[] data,
                                              final byte[] key) {
        return bytes2HexString(encryptAES(data, key, "AES/ECB/PKCS5Padding", null));
    }
     ...
     * @return the bytes of AES encryption
     */
    private static byte[] encryptAES(final byte[] data,
                                    final byte[] key,
     ...
     * @return the bytes of AES decryption
     */
    private static byte[] decryptAES(final byte[] data,
                                    final byte[] key,
                                    final String transformation,
                                    final byte[] iv) {
    ...
    public static byte[] decryptHexStringAES(final String data,
        ...
        return decryptAES(hexString2Bytes(data), key, "AES/ECB/PKCS5Padding", null);
    }
